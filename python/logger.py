...
axes[0,0].set_title('Rectifier current') 
...
axes[0,1].set_title('Rectifier voltage') 
plt.xticks(fontsize=8, rotation = 45)
...
axes[0,2].set_title('Buck current') 
plt.xticks(fontsize=8, rotation = 45)
...
axes[1,0].set_title('Buck voltage') 
plt.xticks(fontsize=8, rotation = 45)
...
axes[1,1].set_title('Buck power') 
plt.xticks(fontsize=8, rotation = 45)

plt.sca(axes[1,2])
axes[1,2].set_ylim(0, 600)
axes[1,2].set_ylabel("RPM")
axes[1,2].set_xlabel("Time")
axes[1,2].set_title('Generator RPM') 
plt.xticks(fontsize=8, rotation = 45)
